...
class LoginViewController: UIViewController, DelegateProtocol {
    ...
    override func viewDidLoad() {
        ...
        user = Profile(fullname: "Minaya", email: "test", birthdate: "12/15/99", password: "test123", phoneNumber: "12345", cards: nil)
...
//                navigationController?.show(homeController, sender: nil)
    ...
    func setText(nameS: String, email: String, bday: String, phoneN: String, passwordL: String) {
        user = Profile(fullname: nameS, email: email, birthdate: bday, password: passwordL, phoneNumber: phoneN, cards: nil)
